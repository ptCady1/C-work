...
namespace Assignments.Migrations.Country
{
    ...
    [Migration("20250305001615_second")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Assignments.Models.Games", b =>
                {
                    b.Property<string>("GamesID")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Assignments.Models.SportType", b =>
                {
                    b.Property<string>("SportTypeID")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Assignments.Models.Country", b =>
                {
                    b.HasOne("Assignments.Models.Games", "Games")
                        .WithMany()
                        .HasForeignKey("GamesID");

                    b.HasOne("Assignments.Models.SportType", "SportType")
                        .WithMany()
